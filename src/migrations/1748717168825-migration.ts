...
export class Migration1748717168825 implements MigrationInterface {
    name = 'Migration1748717168825'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`customer\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`email\` varchar(255) NOT NULL, \`phone\` varchar(255) NOT NULL, \`cpfCnpj\` varchar(255) NOT NULL, \`personType\` varchar(255) NOT NULL, \`stateRegistration\` varchar(255) NOT NULL, \`contributionType\` varchar(255) NOT NULL, \`taxRegime\` varchar(255) NOT NULL, \`fantasyName\` varchar(255) NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`addressId\` int NULL, UNIQUE INDEX \`IDX_fdb2f3ad8115da4c7718109a6e\` (\`email\`), UNIQUE INDEX \`REL_7697a356e1f4b79ab3819839e9\` (\`addressId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`employer\` DROP FOREIGN KEY \`FK_ae971df4a078e19efb565240895\``);
        await queryRunner.query(`ALTER TABLE \`customer\` DROP FOREIGN KEY \`FK_7697a356e1f4b79ab3819839e95\``);
        ...
        await queryRunner.query(`DROP INDEX \`REL_ae971df4a078e19efb56524089\` ON \`employer\``);
