...
export class Migration1748717168825 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`trip\` ADD CONSTRAINT \`FK_985aec23bd881a4047c7c5838b8\` FOREIGN KEY (\`orderIdId\`) REFERENCES \`order\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE \`trip\` ADD CONSTRAINT \`FK_048d7c2a2c4dfcb3a5cd715d715\` FOREIGN KEY (\`vehicleIdId\`) REFERENCES \`vehicle\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE \`trip\` ADD CONSTRAINT \`FK_33fc5b801cdd577966f8f200c0a\` FOREIGN KEY (\`driverIdId\`) REFERENCES \`employer\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`trip\` DROP FOREIGN KEY \`FK_33fc5b801cdd577966f8f200c0a\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`trip\` DROP FOREIGN KEY \`FK_048d7c2a2c4dfcb3a5cd715d715\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`trip\` DROP FOREIGN KEY \`FK_985aec23bd881a4047c7c5838b8\``,
    );
    await queryRunner.query(
